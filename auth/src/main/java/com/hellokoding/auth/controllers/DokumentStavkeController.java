...
public class DokumentStavkeController {
	...
	public String deleteDokumentStavka(@RequestParam Long id, @RequestParam Long brDokumenta,
	...
	public String saveDokumentStavke(@ModelAttribute("dokumentStavke") @Valid DokumentStavke dokumentStavke,
	...
	public ModelAndView updateDokumentStavke(@RequestParam Long id, @RequestParam Long brDokumenta,
			HttpServletRequest request) {
	...
	public List<DokumentStavke> getJsonDokumentiStavke(@RequestParam(value = "itemid") Long id) {
		...
		for (Iterator iterator = aa.iterator(); iterator.hasNext();) {
			...
			dokument.setAkcija("<a href=\"update_dokumentistavke.html?id=" + dokument.getId() + "\"> "
					+ "<i class=\"fa fa-pencil-square-o edit-delete-icon\"></i> </a> "
					+ "            <a href=\"delete_dokumentistavke.html?id=" + dokument.getId()
					+ "\" Onclick=\"return ConfirmDelete();\"> "
					+ "<i class=\"fa fa-trash-o edit-delete-icon\"></i> </a>");
	...
	public String getDokumentiStavkeFinal(Model model, @RequestParam(defaultValue = "0") int page,
	...
	public List<DokumentStavke> getDokumentiStavkeFinalJson(Model model, @RequestParam(defaultValue = "0") int page,
