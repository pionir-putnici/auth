        ...
        <div class='container-fluid'>
            <div class='row spacer-top-20' id='article-card-title'>
                ...
                <div class='col-xs-12 spacer-top-15' id="document-info">
                    <div class='row'>
                        <div class='col-xs-2'><p>Datum izrade:</p></div>
                        <div class='col-xs-2'><p>03.04.2018.</p></div>
                    </div>
                </div>
            </div>
            <div class='row spacer-top-15' id='article-info-storage-location'>
                <div class='col-xs-2'><p>Magacin:</p></div>
                <div class='col-xs-10'><p>Magacin 1</p></div>
            </div>
            <div class='row' id='article-info'>
                <div class='col-xs-2'><p>Å¡ifra</p></div>
                <div class='col-xs-2'><p>naziv</p></div>
            </div>
            <div class='row'>
                <div class='col-xs-12'>
