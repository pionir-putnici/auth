...
<br/>
					...
					</c:if> <!--  end if za partner -->
					
				<!-- ********************* kraj ukupno za partner ************************ -->

						<!-- *************** ispis zaglavlja magacina *********************** -->
<%-- 					<c:if test="${aktivniMagacin!=stavka.idDokument.magacini.id }"> --%>

					<c:if test="${stampaZaglavljaMagacin==true}">
						<c:set value="${false}" var="stampaZaglavljaMagacina"></c:set>
						<c:set var="aktivniMagacin" value="${stavka.idDokument.magacini.id}" />
...
<!-- ********************* kraj ukupno za magacin ************************ -->
					...
					<c:set var="totalKolp" value="${totalKolp + stavka.ulaz-stavka.izlaz}" />
					<c:set var="totalVredp" value="${totalVredp + stavka.duguje-stavka.potrazuje}" />
					...
					<c:set var="totalPotrazujep" value="${totalPotrazujep + stavka.potrazuje}" />					
