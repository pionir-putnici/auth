    ...
    <page size="A4" class="print">
        ...
        <div class='container-fluid spacer-top-20'>
            <div class='row'>
                ...
                <div class='col-xs-5'>
                    <div class='row'>
                       <div class='col-xs-3'>Magacin</div>
                        <div class='col-xs-9'>${dokument.magacini.name}</div>
                    </div>
                    <div class='row'>
                        <div class='col-xs-3'>Adresa</div>
                        <div class='col-xs-9'>${dokument.magacini.adresa}</div>
                    </div>
                </div>
            </div>
            <div class='row spacer-top-20'>
                <div class='col-xs-7'>
                    <div class='row'>
                        <div class='col-xs-12'><h4>${dokument.typesOfDocuments.name} br. ${dokument.brojDokumenta}</h4></div>
                    </div>
                    <div class='row'>
...
<!--                         </tr> -->
		...
		<div class='row spacer-top-20' id='signatureLine'>
			<div class='col-xs-12'>
				<div class='col-xs-6' id='signatureHolder1'>
					<div class='col-xs-12'>
						Predao:
					</div>
				...
				<div class='col-xs-6' id='signatureHolder2'>
					<div class='col-xs-12'>
						Primio:
					</div>
					<div class='col-xs-12 spacer-top-20'>
